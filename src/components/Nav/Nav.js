      ...
      <AppBar position="static" color="primary">
        <Toolbar>
          <NavStyles>
            ...
            <li><NavLink to="/hoc-examples" exact activeClassName="selected">Hoc Examples</NavLink></li>
            <li><NavLink to="/rp-examples" exact activeClassName="selected">RP Examples</NavLink></li>
          </NavStyles>
        </Toolbar>
      </AppBar>
    );
